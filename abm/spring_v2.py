...
class Spring2: 
    ...
    def update_geometry(self, flow_direction):
        ...
        self.tension_cortex = calculate_bilinear_tension(
        ...
        self.tension_sf = max(
            self.k_sf * sf_extension * self.alignment, # weighted by alignment (lateral highest)
    ...
    # ------------------------------------------------------------------
    # 2: Update Signalling (Junction proteins + Rho)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 3: Remodel Mechanical Parameters
    # ------------------------------------------------------------------
