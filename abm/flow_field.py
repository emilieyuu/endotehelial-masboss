...
# def get_junction_input(spring, flow_direction):
#      # Get tensions
#      tension = max (0, spring.length - spring.rest_length)

#      # Get orientation of junction relative to flow
#      junction_vec = (spring.node_1.pos - spring.node_2.pos)
#      junction_unit = junction_vec / np.linalg.norm(junction_vec)

#      # Get alignment vector of junction relative to flow
#      alignment = abs(np.dot(junction_unit, flow_direction))

#      return tension, alignment 
